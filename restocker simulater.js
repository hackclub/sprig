...
// level reset
function resetcheck() {// converted this into a function, you can change it back
if(val1 == true && val2 == true) {
  ...
  if (currentLevel !== undefined) {
    ...
    setMap(currentLevel);
     ...
     //addText("both vals are true!") //sheepy debug
 }
}//function close

//level finish or next level
afterInput(() => {
  //clearText() //SheepyDebug
  //addText(`${val1}${val2}`) //SheepyDebug
  resetcheck()
