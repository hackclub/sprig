...
local_site = input("Are you running the Sprig website locally? (y/n) ").lower() == "y"

if local_site:
    port = input("Which port is the website on? The default is 3000 if you don't enter anything. ")
    port = 3000 if port == "" else int(port)

site = f"http://localhost:{port}" if local_site else "https://sprig.hackclub.com"
...
while True:
    ...
    link = f"{site}/gallery/{filename[:-3].replace(' ', '%20')}"
