...
// A series of words used to detect and represent the beginning of validly saved data
const uint16_t SPRIG_MAGIC[FLASH_PAGE_SIZE / 2] = {1337, 42, 69, 420, 420, 1337};

// A direct pointer to the flash memory region where we save data
const uint8_t *flash_target_contents = (const uint8_t *)(XIP_BASE + FLASH_TARGET_OFFSET);

void upl_flush_buf(void)
{
