...
Use WASD keys to move Crummington and dodge the toasters! Try to collect jam jars, they boost your score
 
Warning: don't press j before it tells you too --> weird stuff happends :D
*/
...
addText("story loading...", {y: 8, color: color`L`,})
 
setInterval(function(){
    if (screen == 1){
      clearText()
      addText("Once upon a time", {y: 1, color: color`0`,})
      addText("there was a piece of", {y: 2, color: color`0`,})
      addText("bread who found a", {y: 3, color: color`0`,})
      addText("way to grow limbs.", {y: 4, color: color`0`,})
      screen = 2;
    }
    else if (screen == 2)
    {
      clearText()
      addText("He wanted to share", {y: 1, color: color`0`,})
      addText("his formula with", {y: 2, color: color`0`,})
      addText("others!", {y: 3, color: color`0`,})
      addText("Unfortunately, he", {y: 4, color: color`0`,})
      addText("was caught by an", {y: 5, color: color`0`,})
      addText("evil scientist,", {y: 6, color: color`0`,})
      addText("who has an army", {y: 7, color: color`0`,})
      addText("of toasters!", {y: 8, color: color`0`,})
      screen = 3;
    }
  else if (screen == 3)
  {
    ...
    addText("can help Crummington the Ninth", {y: 3, color: color`0`,})
    addText("escape the scientists", {y: 4, color: color`0`,})
