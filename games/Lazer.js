...
@title: Lazer
@author: Ghost/FaazX
@description: In LAZER, you play as a nimble cat trying to survive in a room filled with deadly lasers. The objective is to avoid being hit by lasers while progressing through increasingly difficult rounds. Each round you survive adds points to your score, and the game ends when you either reach 100 points to win or get hit by a laser. What makes the game unique is its fast-paced, reflex-based gameplay, combined with a clear warning system that shows where lasers will appear, giving players a chance to dodge.
@tags: [reflex, fun, pixel, sprig, action]
@addedOn: 2025-09-17 
*/
