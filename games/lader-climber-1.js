...
const keyHandlers = () => {
    ...
    onInput("l", () => {
  // Clear the vertical movement interval if it is active
  if (moveUpInterval) {
...
onInput("s", () => {
    // Clear any existing text on the screen
    clearText();
    ...
    // Allow the player to move again by resetting the movement flag
