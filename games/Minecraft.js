...
onInput("j", () => {
  // Rotate facing direction counterclockwise
  facingDir = (facingDir - 1 + 4) % 4;
...
addText("WASD: Move/Jump  S: Mine", { x: 1, y: 14, color: color`2` });
addText("I: Place  J/K: Rotate  L: Item", { x: 1, y: 15, color: color`2` });