/*
COLOR SWITCHER — Step 8 (Level Select Menu)
- Fancy boxed menu
- Level unlock system
- W/S navigation, J to play, K to back
- Uses a small background map so menu displays correctly
- 4 levels (B option)
*/
...
showMenu();
startIdleAnimation();
/* --- HINT: compute press-set and show markers on press tiles (toggle with H) --- */
