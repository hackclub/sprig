...
const walk = tune`
37.5: B4~37.5 + C5/37.5 + A4~37.5 + G5-37.5 + E4~37.5,
37.5: B4^37.5 + A4-37.5 + C5-37.5 + C4^37.5 + E5/37.5,
1125`

//Ok now

onInput("k", () => {
  getFirst(MrMan).y += 1; //down
  playTune(walk)
});

onInput("l", () => {
  getFirst(MrMan).x += 1; //right
  playTune(walk)
});

onInput("i", () => {
  getFirst(MrMan).y -= 1; //up
  playTune(walk)
});

onInput("j", () => {
    getFirst(MrMan).x -= 1; //left
    playTune(walk)
});
...
const reset = tune`
37.5: B4/37.5 + C5~37.5 + A4-37.5,
37.5: A4~37.5 + C5^37.5 + B4-37.5,
37.5: B4^37.5 + C5-37.5 + A4/37.5,
1087.5`
