...
@tags: []
@addedOn: 2024-01-01
@description: A strategic cellular automata game inspired by Conway's Game of Life. Players take turns placing cells on the grid using 'WASD' to move the cursor and 'I' to place cells. Player 1 has red cells and Player 2 has blue cells. After all cells are placed, watch them evolve according to Game of Life rules. The player with the most surviving cells after 15 seconds wins!
*/
