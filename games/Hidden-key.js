...
@description: This is a simple game which consists of 8 levels and each level has one key hidden somewhere random. Go through the entire maze to find the hidden key and unlock the next level.
@tags: ['escape', 'puzzle']
@addedOn: 2025-12-10
*/
const P = "p";
