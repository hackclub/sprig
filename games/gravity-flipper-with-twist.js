/*
@title: Gravity Platformer with Twists
@author:manikanta
@tags: ['platformer', 'gravity', 'puzzle']

Controls:
- L: Continue / Start / Next Level
- A/D: Move left/right
- W: Flip gravity
- J: Reset level
- K: Retry level / Restart game

Platform Mechanics:
- WALLS (black): Always solid
- BLUE PLATFORMS: Solid when gravity is DOWN, passable when gravity is UP
- RED PLATFORMS: Solid when gravity is UP, passable when gravity is DOWN
- SPIKES: Instant death
- GOAL: Reach to win level
*/
...
// Check if there's a solid obstacle at position (x, y)
// Blue platforms are solid from ALL sides when gravity is normal (down)
// Red platforms are solid from ALL sides when gravity is flipped (up)
// When platforms are "inactive" (opposite gravity), they're completely passable
...
function showLevelComplete() {
  ...
  addText(`Level ${currentLevel}/${levels.length}`, { x: 4, y: 8, color: color`2` });
