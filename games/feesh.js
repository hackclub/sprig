...
@description: play as a feesh exploring the wonders of the reef, pushing aside shells, weaving through the kelp and solving the puzzles. Collect all the shiny rocks using 'k' and rush to cpt. Starfish to continue through the ocean. (If you get trapped use 'i' to escape safely) 
@tags: ['adventure']
@addedOn: 2026-03-12
*/
