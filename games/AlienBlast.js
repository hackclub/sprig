...
function showMainMenu() {
  ...
  // help texts
  addText("W/S move", { x: 1, y: 14, color: color`2` })
  addText("J select", { x: 1, y: 15, color: color`2` })
}
function showSkinsMenu() {
  ...
  addText("J confirm", { x: 1, y: 14, color: color`2` })
  addText("K back", { x: 1, y: 15, color: color`2` })
}
...
function gameOverScreen() {
  ...
  addText("J to restart", { x: 3, y: 6, color: color`2` })
  addText("K to menu", { x: 3, y: 7, color: color`2` })
}
